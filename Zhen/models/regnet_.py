import numpy as np
from models.utils import AnyNet, WrappedModel
import torch
...
# https://drive.google.com/drive/folders/1lbIBzQNW2CqbmnbAkY8DM5apzq_YXWFc
# https://github.com/yhhhli/RegNet-Pytorch

model_paths = {
    'regnet_200m': '../ckpts/regnet_200m.pth.tar',
    'regnet_400m': '../ckpts/regnet_400m.pth.tar',
    'regnet_600m': '/media/zyi/080c2d74-aa6d-4851-acdc-c9588854e17c/ISIC_2020/models/pre_trained_model/regnet_600m.pth.tar',
    'regnet_800m': '/media/zyi/080c2d74-aa6d-4851-acdc-c9588854e17c/ISIC_2020/models/pre_trained_model/regnet_800m.pth.tar',
...
if __name__ == '__main__':
    ...
    net = regnet_800M(pretrained=True)
    # print(net)
    print(list(list(net.children())[0].children())[0])
    # print(list(list(net.children())[0].children())[-1])
    out = net(input_seq)
    print(out.shape)
